      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td bgcolor="#1a1a2e" style="border-radius:8px 8px 0 0;padding:32px 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td>
                  <p style="margin:0 0 4px 0;font-size:11px;color:#7986cb;letter-spacing:2px;text-transform:uppercase;font-weight:600;">
                    DAILY TECH DIGEST
                  </p>
                  <h1 style="margin:0 0 8px 0;font-size:26px;font-weight:800;color:#ffffff;line-height:1.2;">
                    Top 10 Tech &amp; Startup News
                  </h1>
                  <p style="margin:0;font-size:14px;color:#90caf9;">
                    ${formattedDate} &nbsp;&middot;&nbsp; Europe &amp; World
                  </p>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td bgcolor="#0d47a1" style="padding:12px 28px;">
            <p style="margin:0;font-size:13px;color:#e3f2fd;">
              Your AI-curated daily briefing on European startups, global VC, and tech innovation — powered by Claude.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td bgcolor="#1a1a2e" style="border-radius:0 0 8px 8px;padding:24px 28px;">
            <p style="margin:0 0 8px 0;font-size:13px;color:#90caf9;line-height:1.6;">
              Sources: TechCrunch, EU-Startups, Sifted, The Next Web, VentureBeat, Wired, Hacker News, NewsAPI
            </p>
            <p style="margin:0;font-size:12px;color:#546e7a;">
              Curated by Claude AI &nbsp;&middot;&nbsp; Delivered automatically every morning
            </p>
          </td>
        </tr>
